...
public class GUI_MemberRentalPS extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        member.dataTotalBiaya((int)Double.parseDouble(txtTotal.getText())); // Mengambil nilai total biaya dari input txtTotal dan menyimpannya dalam atribut total objek member
