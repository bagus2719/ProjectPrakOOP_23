...
import Project.TugasBab1.RentalPS;
...
public class GUI_RentalPS extends javax.swing.JFrame {
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        ...
        rntl.dataKodeSewa(txtKode.getText());
        rntl.dataNamaPenyewa(txtNama.getText());
        ...
        rntl.dataTanggalSewa(txtTgl.getText());
        ...
        // Hitung Total biaya
        int totalBiaya;
        totalBiaya = hargaSewa * waktuSewa;
        rntl.TotalBiaya = totalBiaya;
        
        // Tampilkan hasil pada memoRentalPS
        memoRentalPS.append("\tRental PlayStation\n");
        memoRentalPS.append("-------------------------------------------------------------------\n");
        memoRentalPS.append("Kode Sewa     : " + rntl.getKodeSewa()+"\n");
        memoRentalPS.append("Jenis PS      : " + JenisPS + "\n");
        memoRentalPS.append("Nama Penyewa : " + rntl.getNamaPenyewa()+ "\n");
        memoRentalPS.append("Tanggal Sewa : " + rntl.getTanggalSewa()+"\n");
        memoRentalPS.append("Waktu Sewa   : " + rntl.getWaktuSewa()+ "\n");
        memoRentalPS.append("Harga/Jam    : " + hargaSewa + "\n");
        memoRentalPS.append("Total Biaya  : " + rntl.getTotalBiaya()+ "\n");
