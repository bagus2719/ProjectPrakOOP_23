...
import TugasBAB7.Polimorfisme.MemberRentalPS;
...
public class GUI_MemberRentalPS extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        member.setIdMember(Integer.parseInt(txtId.getText())); // Mengisi ID Member dari input txtId dan menyimpannya dalam objek member
        member.setNamaMember(txtNama.getText()); // Mengisi Nama Member dari input txtNama dan menyimpannya dalam objek member
        member.setAlamatMember(txtAlamat.getText()); // Mengisi Alamat Member dari input txtAlamat dan menyimpannya dalam objek member
        ...
        member.TotalBiaya = ((int)Double.parseDouble(txtTotal.getText())); // Mengambil nilai total biaya dari input txtTotal dan menyimpannya dalam atribut total objek member
        double diskonAmount = member.TotalBiaya * diskon; // Menghitung jumlah diskon berdasarkan jenis member yang telah dipilih
        double biayaSetelahDiskon = member.TotalBiaya - diskonAmount; // Menghitung total biaya setelah diberikan diskon
        ...
        txthasil.append("Total Biaya\t : " + member.hitTotalBiaya() + "\n");
