...
public class GUI_PemesananPS extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtKodeSeri.setFont(new java.awt.Font("MS Reference Sans Serif", 0, 14)); // NOI18N

        txtStok.setFont(new java.awt.Font("MS Reference Sans Serif", 0, 14)); // NOI18N

        cmbStatus.setFont(new java.awt.Font("MS Reference Sans Serif", 0, 14)); // NOI18N
        ...
        rdbtnPS2.setFont(new java.awt.Font("MS Reference Sans Serif", 0, 14)); // NOI18N
        rdbtnPS2.setText("PS2");

        btngrpOrder.add(rdbtnPS3);
        rdbtnPS3.setFont(new java.awt.Font("MS Reference Sans Serif", 0, 14)); // NOI18N
        rdbtnPS3.setText("PS3");

        btngrpOrder.add(rdbtnPS4);
        rdbtnPS4.setFont(new java.awt.Font("MS Reference Sans Serif", 0, 14)); // NOI18N
        rdbtnPS4.setText("PS4");

        btngrpOrder.add(rdbtnPS5);
        rdbtnPS5.setFont(new java.awt.Font("MS Reference Sans Serif", 0, 14)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        //Mengosongkan teks pada komponen txtHasil
        txtHasil.setText("");

        //Membuat Object PemesananPS
        PemesananPS pesanan = new PemesananPS();

        // Mengisi data nama penyewa dari input txtNama
        pesanan.dataNamaPenyewa(txtNama.getText());

        // Menginisialisasi variabel jenisPS berdasarkan pilihan dari radio button
        String JenisPS = "";
        ...
        // Mengatur seri PlayStation dan stok berdasarkan input dari GUI
        pesanan.dataSeriStokPS(txtKodeSeri.getText(), Integer.parseInt(txtStok.getText()));
        ...
        txtHasil.append("Stok PS\t  : " + pesanan.getStokPS() + "\n");
