...
public class GUI_MemberRentalPS extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String JenisMember = ""; // Variabel untuk menyimpan jenis member berdasarkan pilihan combo box
        String disc = ""; //Variabel untuk menyimpan persentasi diskon berdasarkan pilihan
        ...
        member.setJenisMember(JenisMember); //mengatur nilai atau data pada jenis mmember
        member.Total = (int)Double.parseDouble(txtTotal.getText()); //mengatur nilai total yang didambil dari txtTotal
        ...
        txtAlamat.setText("");
        txtTotal.setText("");
        cmbjenisMember.setSelectedIndex(-1);
